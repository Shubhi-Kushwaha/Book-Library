...
export default function LoginPage() {
  ...
  return (
    <div
      className="min-h-screen relative overflow-x-hidden flex items-center justify-center p-4 sm:p-6 lg:p-8"
      style={{
        background:
    ...
    >
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden p-6 sm:p-8 lg:p-10">
